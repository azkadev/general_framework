...
extension GetAccountDatabaseCollection on DatabaseUniverse {
  DatabaseUniverseCollection<int, AccountDatabase> get accountDatabases =>
      this.collection();
}

const AccountDatabaseSchema = DatabaseUniverseGeneratedSchema(
  ...
  converter: DatabaseUniverseObjectConverter<int, AccountDatabase>(
...
int serializeAccountDatabase(
    DatabaseUniverseWriter writer, AccountDatabase object) {
  DatabaseUniverseCore.writeString(writer, 1, object.special_type);
  DatabaseUniverseCore.writeString(writer, 2, object.first_name);
  DatabaseUniverseCore.writeString(writer, 3, object.last_name);
  DatabaseUniverseCore.writeString(writer, 4, object.username);
  DatabaseUniverseCore.writeString(writer, 5, object.bio);
  DatabaseUniverseCore.writeString(writer, 6, object.password);
  DatabaseUniverseCore.writeString(writer, 7, object.from_app_id);
  DatabaseUniverseCore.writeLong(writer, 8, object.owner_account_user_id);
  return object.id;
}

@databaseUniverseProtected
AccountDatabase deserializeAccountDatabase(DatabaseUniverseReader reader) {
  ...
  object.first_name = DatabaseUniverseCore.readString(reader, 2) ?? '';
  object.last_name = DatabaseUniverseCore.readString(reader, 3) ?? '';
  object.username = DatabaseUniverseCore.readString(reader, 4) ?? '';
  object.bio = DatabaseUniverseCore.readString(reader, 5) ?? '';
  object.password = DatabaseUniverseCore.readString(reader, 6) ?? '';
  object.from_app_id = DatabaseUniverseCore.readString(reader, 7) ?? '';
  object.owner_account_user_id = DatabaseUniverseCore.readLong(reader, 8);
  return object;
}

@databaseUniverseProtected
dynamic deserializeAccountDatabaseProp(
  ...
  switch (property) {
    ...
    case 6:
      return DatabaseUniverseCore.readString(reader, 6) ?? '';
    case 7:
      return DatabaseUniverseCore.readString(reader, 7) ?? '';
    case 8:
      return DatabaseUniverseCore.readLong(reader, 8);
    default:
...
class _AccountDatabaseUpdateImpl implements _AccountDatabaseUpdate {
  ...
  final DatabaseUniverseCollection<int, AccountDatabase> collection;
...
extension AccountDatabaseUpdate
    on DatabaseUniverseCollection<int, AccountDatabase> {
...
class _AccountDatabaseQueryUpdateImpl implements _AccountDatabaseQueryUpdate {
  ...
  final DatabaseUniverseQuery<AccountDatabase> query;
  final int? limit;
...
extension AccountDatabaseQueryUpdate on DatabaseUniverseQuery<AccountDatabase> {
