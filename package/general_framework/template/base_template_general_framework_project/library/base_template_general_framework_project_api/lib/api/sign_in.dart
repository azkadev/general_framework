...
extension BaseTemplateGeneralFrameworkProjectApiExtensionsignInSession on BaseTemplateGeneralFrameworkProjectApi {
  FutureOr<Session> api_signIn({
    ...
    // validation
    {
      ...
      final Map? validation_password = BaseTemplateGeneralFrameworkProjectSchemeValidation.usernameValidation(username: password_parameters);
