...
import 'package:base_web_template_general_framework_project_scheme/database_scheme/session_database.dart';
...
extension BaseWebTemplateGeneralFrameworkProjectApiDatabaseExtensionSession on BaseWebTemplateGeneralFrameworkProjectApiDatabase {
  Future<String?> session_generateNewToken() async {
    while (true) {
      await Future.delayed(Duration(milliseconds: 1));
      final String new_token = BaseWebTemplateGeneralFrameworkProjectSchemeDefault.utils_generateSessionToken();
