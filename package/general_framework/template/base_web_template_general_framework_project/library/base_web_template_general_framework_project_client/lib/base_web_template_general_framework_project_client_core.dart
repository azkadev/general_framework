...
import 'package:base_web_template_general_framework_project_client_database/account/account.dart';
...
import 'package:base_web_template_general_framework_project_client_database/session/session.dart';
...
import 'package:base_web_template_general_framework_project_scheme/extension/map.dart';
...
class BaseWebTemplateGeneralFrameworkProjectClient extends GeneralFrameworkClient<BaseWebTemplateGeneralFrameworkProjectClientDatabase> {
  final BaseWebTemplateGeneralFrameworkProjectSecretClientSide baseTemplateGeneralFrameworkProjectSecretClientSide;
  ...
  FutureOr<Map?> onInvokeValidationDefault(Map<dynamic, dynamic> parameters, GeneralFrameworkClientInvokeOptions generalFrameworkClientInvokeOptions) async {
    final String client_token = parameters.base_web_template_general_framework_project_scheme_utils_special_client_token();
