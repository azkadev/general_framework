...
import 'package:base_web_template_general_framework_project_scheme/api_scheme/sign_up.dart';
...
void main(List<String> arguments) async {
  print("start");
  final BaseWebTemplateGeneralFrameworkProjectClient client = BaseWebTemplateGeneralFrameworkProjectClient(
