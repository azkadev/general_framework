...
class Accounts extends JsonScheme {
  ...
  static Map get defaultData {
    return {"@type":"accounts","total_count":0,"accounts":[{"@type":"account"}],"@extra":"","@expire_date":"","@client_id":""};
  }
  ...
  List<Account> get accounts {
    try {
      ...
      return (rawData["accounts"] as List).map((e) => Account(e as Map)).toList().cast<Account>();
    } catch (e) {
      return [];
    }
  }
