...
import 'package:base_web_template_general_framework_project_scheme/schemes/api_scheme.dart';
import 'package:base_web_template_general_framework_project_scheme/schemes/database_scheme.dart';
import 'package:base_web_template_general_framework_project_scheme/schemes/respond_scheme.dart';
import 'package:base_web_template_general_framework_project_scheme/schemes/schemes.dart';
import 'package:base_web_template_general_framework_project_scheme/schemes/update_scheme.dart';
...
extension BaseWebTemplateGeneralFrameworkProjectApiExtension${special_type.toLowerCaseFirstData()}${return_type} on BaseWebTemplateGeneralFrameworkProjectApi {
...
Future<void> generateIsarDatabase() async {
  ...
  final Directory directory = Directory(path.join(
    Directory.current.path,
    "..",
    "base_web_template_general_framework_project_isar_scheme",
  ));
