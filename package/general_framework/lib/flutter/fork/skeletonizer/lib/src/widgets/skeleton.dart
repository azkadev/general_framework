...
class _IgnoreSkeleton extends SingleChildRenderObjectWidget implements Skeleton {
  ...
  @override
  RenderObject createRenderObject(BuildContext context) {
    return RenderIgnoredSkeleton(enabled: enabled && isSkeletonizerGeneralFrameworkEnabled(context));
  }
  ...
  void updateRenderObject(
    ...
    renderObject.enabled = enabled && isSkeletonizerGeneralFrameworkEnabled(context);
  }
}
...
class _KeepSkeleton extends _BasicSkeleton {
  ...
  @override
  void paint(SkeletonizerGeneralFrameworkPaintingContext context, rect, paint, _) {
...
class _UnitingSkeleton extends _BasicSkeleton {
  ...
  @override
  void paint(SkeletonizerGeneralFrameworkPaintingContext context, Rect paintBounds, Painter paint, textDirection) {
...
class _LeafSkeleton extends _BasicSkeleton {
  ...
  @override
  void paint(SkeletonizerGeneralFrameworkPaintingContext context, Rect paintBounds, Painter paint, _) {
...
class _SkeletonReplace extends StatelessWidget implements Skeleton {
  ...
  Widget build(BuildContext context) {
    final doReplace = enabled && SkeletonizerGeneralFramework.maybeOf(context)?.enabled == true;
    return SizedBox(
      width: width,
      height: height,
...
class _SkeletonIgnorePointer extends StatelessWidget implements Skeleton {
  ...
  @override
  Widget build(BuildContext context) {
    final ignoring = enabled && SkeletonizerGeneralFramework.maybeOf(context)?.enabled == true;
