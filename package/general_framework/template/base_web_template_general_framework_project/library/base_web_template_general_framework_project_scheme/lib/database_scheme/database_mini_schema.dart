...
class DatabaseMiniSchema extends JsonScheme {
  ...
  static Map get defaultData {
    return {"@type":"databaseMiniSchema","application_configuration":{"@type":"applicationConfiguration"},"accounts":[{"@type":"accountDatabase"}],"sessions":[{"@type":"sessionIsarDatabase"}],"from_app_id":"","owner_account_user_id":0};
  }
  ...
  ApplicationConfiguration get application_configuration {
    try {
      ...
      return ApplicationConfiguration(rawData["application_configuration"] as Map);
    } catch (e) {  
      return ApplicationConfiguration({}); 
    }
  }
  ...
  List<AccountDatabase> get accounts {
    try {
      ...
      return (rawData["accounts"] as List).map((e) => AccountDatabase(e as Map)).toList().cast<AccountDatabase>();
    } catch (e) {
      return [];
    }
  }
  ...
  List<SessionIsarDatabase> get sessions {
    try {
      ...
      return (rawData["sessions"] as List).map((e) => SessionIsarDatabase(e as Map)).toList().cast<SessionIsarDatabase>();
    } catch (e) {
      return [];
    }
  }
...
final Map databaseMiniSchema_data_create_json = {
      ...
      "@type": special_type,
      "application_configuration": (application_configuration != null)?application_configuration.toJson(): null,
      ...
      "owner_account_user_id": owner_account_user_id,
          ...
          databaseMiniSchema_data_create_json.removeWhere((key, value) => value == null);
