...
git init
git branch -M main
git remote add origin https://github.com/azkadev/general_framework
git remote set-url --push origin https://azkadev:{main_github_token}@github.com/azkadev/general_framework
