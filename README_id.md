...
**WIP General Framework** adalah library berbagai platform, library ini  membantu anda membuat program untuk berbagai platform menggunakan style code flutter,

library ini di buat agar memudahkan anda lagi untuk membangun di sisi server / membuat demo, sehingga anda tidak perlu kerja 2x untuk membuat demo 
