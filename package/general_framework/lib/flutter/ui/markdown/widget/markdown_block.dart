...
///use [MarkdownBlockGeneralFrameworkWidget] to build markdown by [Column]
///it does not support scrolling by default, but it will adapt to the width automatically.
class MarkdownBlockGeneralFrameworkWidget extends StatelessWidget {
  ///the markdown data
  final String data;
  ...
  Widget build(BuildContext context) {
    final markdownGenerator = generator ?? MarkdownGeneralFrameworkGenerator();
