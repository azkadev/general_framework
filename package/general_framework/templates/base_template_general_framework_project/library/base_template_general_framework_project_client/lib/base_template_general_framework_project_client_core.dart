...
class BaseTemplateGeneralFrameworkProjectClient extends GeneralFrameworkClient {
  ...
  FutureOr<void> ensureInitialized({
    ...
    await super.ensureInitialized(
      ...
      onInvokeRequest: (result, parameters, generalFrameworkClientInvokeOptions) async {
  ...
  FutureOr<dynamic> onInvokeRequestDefault(Map<dynamic, dynamic> result, Map<dynamic, dynamic> parameters, GeneralFrameworkClientInvokeOptions generalFrameworkClientInvokeOptions) {}

  FutureOr<dynamic> onInvokeResultDefault(Map<dynamic, dynamic> result, Map<dynamic, dynamic> parameters, GeneralFrameworkClientInvokeOptions generalFrameworkClientInvokeOptions) {}
